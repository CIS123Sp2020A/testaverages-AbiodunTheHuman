...
class TestAvg:
    def __init__(self):
        ...
        #create self.letter_label = tkinter(Label(self.let_frame,
        #   text
    ...
    def calc_avg(self):
        ...
        if self.average >= 90:
            self.letter.set('A')
        elif self.average <= 89 and self.average >= 80:
            self.letter.set('B')
        elif self.average <= 79 and self.average >= 70:
            self.letter.set('C')
        elif self.average <= 69 and self.average >= 60:
            self.letter.set('D')
        elif self.average <= 59:
            self.letter.set('F')
